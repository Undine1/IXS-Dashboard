...
- Runs an hourly updater (`scripts/update_pool_volume_indexer.js`) via the `Update Dashboard Data` GitHub Actions workflow (cron minute 23, off the congested top of the hour).
